...
<script setup>
	...
	onMounted(() => {
		if (product.value && window.umami) {
			window.umami.track("view_product", { product_id: product.value.id, product_name: product.value.name, price: product.value.price });
		}
	});
	...
	function handleAddToCart() {
		...
		if (window.umami) {
			window.umami.track("add_to_cart", { product_id: product.value.id, product_name: product.value.name, price: product.value.price });
		}
